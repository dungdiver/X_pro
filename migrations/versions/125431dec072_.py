...
Revision ID: 125431dec072
Revises: 7657c4d26326
Create Date: 2020-10-10 07:29:10.489470
...
revision = '125431dec072'
down_revision = '7657c4d26326'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('ma', sa.NCHAR(length=3), nullable=True),
    sa.Column('khoi', sa.NCHAR(length=20), nullable=True),
